...
public class PetModel extends TypewriterBaseModel implements Serializable {
    public String name;
    public int limbs;
    public String color;
    @SuppressWarnings("unchecked")
    public PetModel(PetProto prototype) {
        PetProto preprocess = initializerPreprocess(prototype);
        this.name = preprocess.name;
        this.color = preprocess.color;
        this.limbs = Integer.parseInt(preprocess.limbs);
    }
    public PetProto initializerPreprocess(PetProto preprocess) {
        return preprocess;
    }
    @Override
    public boolean equals(Object obj) {
        if (obj == this) return true;
        if (!(obj instanceof PetModel)) return false;
